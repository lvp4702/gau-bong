            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-12">
                    ...
                    <form id="product-form" class="form-horizontal" method="post"
                        action="admin.php?controller=comment&action=edit" enctype="multipart/form-data" role="form">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input name="name" type="text"
                                        value="<?php echo $comment ? $comment['author'] : ''; ?>" class="form-control"
                                        id="name" placeholder="họ và tên thật..." required="" />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input name="email" type="email" maxlength="100"
                                        value="<?php echo $comment ? $comment['email'] : ''; ?>" class="form-control"
                                        id="color" placeholder="Nhập email của bạn..." required="" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <textarea name="subject" type="text" class="form-control" id="ckeditor" required
                                        placeholder="Nội dung phản hồi..."><?php echo $comment ? $comment['content'] : ''; ?></textarea>
                                </div>
                            </div>
                        </div>
                        <h4>Status:</h4>
                        ...
                        <div class="form-group" style="text-align: center;">
                            <button class="btn btn-primary waves-effect" type="submit">Update lại thông tin phản
                                hồi</button>
