...
<aside id="leftsidebar" class="sidebar">
    <div class="navbar-brand">
        ...
        <a href="index.php"><img src="admin/themes/images/logo.svg" width="25" alt="Aero"><span class="m-l-10">Shop gấu
            </span></a>
    </div>
    <div class="menu">
        <ul class="list">
            <li>
                <div class="user-info">
                    <a class="image" href="admin.php?controller=user&action=info&user_id=<?= $user_nav ?>"><img
                            src="public/upload/images/<?= $user_info_nav['user_avatar'] ?>" alt="User"></a>
                    <div class="detail">
                        <h4>
                            <?= $user_info_nav['user_name'] ?>
                        </h4>
                        <small>
                            <?php if ($user_info_nav['role_id'] == 1)
                                echo 'Admin';
                            elseif ($user_info_nav['role_id'] == 2)
                                echo 'Moderator';
                            else
                                echo "User"; ?>
                        </small>
            ...
            <li class="open"><a href="<?= PATH_URL ?>home" target="_blank"><i class="zmdi zmdi-home"></i><span>Quay lại
                        SHOP</span></a></li>
            <li <?php if (isset($home_nav))
                echo $home_nav; ?>><a href="admin.php"><i
                        class="zmdi zmdi-view-dashboard"></i><span>Bảng điều khiển</span></a></li>
            <li <?php if (isset($nav_profile))
                echo $nav_profile; ?>><a href="javascript:void(0);"
                    class="menu-toggle"><i class="zmdi zmdi-account"></i><span>Profile</span></a>
                <ul class="ml-menu">
                    <li><a href="admin.php?controller=user&action=info&user_id=<?= $user_nav ?>">Your profile</a></li>
                    <li><a href="admin.php?controller=user&action=change-password&user_id=<?= $user_info_nav['id'] ?>">Change
                            your Password</a></li>
                </ul>
            </li>
            <li <?php if (isset($your_feedback))
                echo $your_feedback; ?>><a
                    href="admin.php?controller=feedback&action=myfeedback"><i class="zmdi zmdi-mail-send"></i><span>Your
                        Feedback</span></a></li>
            <li <?php if (isset($your_Purchase))
                echo $your_Purchase; ?>><a href="javascript:void(0);"
                    class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>Your Purchase</span></a>
                <ul class="ml-menu">
            ...
            <?php if ($user_info_nav['role_id'] != 0):
                if ($user_info_nav['role_id'] == 1): ?>
                    <li <?php if (isset($nav_category))
                        echo $nav_category; ?>> <a href="javascript:void(0);"
                            class="menu-toggle"><i class="zmdi zmdi-folder"></i><span>Quản lý danh mục</span></a>
                        <ul class="ml-menu">
                    ...
                    <li <?php if (isset($backupdb))
                        echo $backupdb; ?>><a href="javascript:void(0);" class="menu-toggle"><i
                                class="zmdi zmdi-dns"></i><span>Backup</span></a>
                        <ul class="ml-menu">
                    ...
                    <li <?php if (isset($nav_hf))
                        echo $nav_hf; ?>><a href="javascript:void(0);" class="menu-toggle"><i
                                class="zmdi zmdi-view-web"></i><span>Setup View Web</span></a>
                        <ul class="ml-menu">
                    ...
                    <li <?php if (isset($nav_admin))
                        echo $nav_admin; ?>><a href="javascript:void(0);" class="menu-toggle"><i
                                class="zmdi zmdi-account"></i><span>Admin</span></a>
                        <ul class="ml-menu">
                            <li><a href="admin.php?controller=user&action=info&user_id=<?= $user_nav ?>">Your Profile</a></li>
                ...
                <?php endif; ?>
                <li <?php if (isset($nav_page))
                    echo $nav_page; ?>><a href="javascript:void(0);" class="menu-toggle"><i
                            class="zmdi zmdi-blogger"></i><span>Blog -> Page</span></a>
                    <ul class="ml-menu">
                ...
                <li <?php if (isset($nav_post))
                    echo $nav_post; ?>><a href="javascript:void(0);" class="menu-toggle"><i
                            class="zmdi zmdi-blogger"></i><span>Blog -> Post</span></a>
                    <ul class="ml-menu">
                ...
                <li <?php if (isset($nav_product))
                    echo $nav_product; ?>> <a href="javascript:void(0);"
                        class="menu-toggle"><i class="zmdi zmdi-collection-text"></i><span>Quản lý sản phẩm</span></a>
                    <ul class="ml-menu">
                ...
                <li <?php if (isset($nav_order))
                    echo $nav_order; ?>><a href="javascript:void(0);" class="menu-toggle"><i
                            class="zmdi zmdi-shopping-cart"></i><span>Quản lý đơn hàng</span></a>
                    <ul class="ml-menu">
                ...
                <li <?php if (isset($nav_user))
                    echo $nav_user; ?>><a href="javascript:void(0);" class="menu-toggle"><i
                ...
                <li <?php if (isset($nav_media))
                    echo $nav_media; ?>><a href="javascript:void(0);" class="menu-toggle"><i
                            class="zmdi zmdi-collection-folder-image"></i><span>Media</span></a>
                    <ul class="ml-menu">
                ...
                <li <?php if (isset($nav_feedback))
                    echo $nav_feedback; ?>><a href="javascript:void(0);"
                        class="menu-toggle"><i class="zmdi zmdi-email-open"></i><span>Feedback Manager</span></a>
                    <ul class="ml-menu">
                ...
                <li <?php if (isset($nav_comment))
                    echo $nav_comment; ?>><a href="javascript:void(0);"
                        class="menu-toggle"><i class="zmdi zmdi-comments"></i><span>Comment Manager</span></a>
                    <ul class="ml-menu">
