...
if (isset($image_product))
	...
	$link_image = PATH_URL . 'public/img/favicon-chikoiquan-tan-hong-it.png';
...
<head>
	...
	<meta charset="utf-8">
	<title>
		Trang chủ : Shop gấu bông
	</title>
	<meta name="keywords" content="Shop gấu bông " />
	<meta name="description" content="Shop gấu bông">
	<meta name="author" content="chikoiquan.com">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<link rel=icon href="public/img/public/img/atmin.png" sizes="32x32">
	<link rel="shortcut icon" href="public/img/public/img/atmin.png" type="image/x-icon" />
	<link rel="apple-touch-icon" sizes="180x180" href="public/img/atmin.png">
	...
	<meta property="og:site_name" content="Shop gấu bông" />
	<meta property="og:title" content="<?php echo isset($title) ? $title : 'Shop gấu bông'; ?>" />
	<meta property="article:tag" content="<?php echo isset($title) ? $title : 'Shop gấu bông'; ?>" />
	...
	<meta property="og:description" content="Bán các loại gấu bông, gối ôm,...." />
	<meta property="og:image" content="public/img/public/img/atmin.png" />
	<meta property="og:image:secure_url" content="public/img/public/img/atmin.png" />
	<meta property="og:image:width" content="700" />
	<meta property="og:image:height" content="345" />
	<meta property="og:locale" content="vi_VN" />
	<meta property="fb:app_id" content="517386205818335" />
	<meta name="twitter:description" content="Bán các loại gấu bông, gối ôm,...." />
	<meta name="twitter:card" content="summary_large_image" />
	<meta name="twitter:title" content=" Shop gấu bông" />
					...
					<a href="home">
						<?php if (isset($link_logo)): ?>
							<img alt="Porto" width="111" height="54" data-sticky-width="82" data-sticky-height="40"
								src="public/img/logo_head.png"><?php endif; ?>
					</a>
				</div>
				<nav>
					<ul class="nav nav-pills nav-top">
						...
						<?php else: ?>
							<li>
								<a onclick="return confirm('Bạn có chắc muốn đăng xuất?')"
									href="admin.php?controller=home&action=logout"><strong><i
											class="fa fa-sign-out"></i>Đăng xuất</strong></a>
							</li>
						<?php endif; ?>
						<li class="phone">
							...
							<li class="dropdown active">
								...
								<ul class="dropdown-menu">
									...
									<li class="dropdown-submenu">
										<a href="javascript:void(0);">Về shop gấu</a>
										<ul class="dropdown-menu">
							...
							<?php foreach ($ccategories as $ccategory): ?>
								<li class="dropdown">
									<a class="dropdown-toggle"
										href="shop/<?php echo $ccategory['id'] ?>-<?php echo $ccategory['slug'] ?>">
												...
												<div class="row">
													<div class="col-md-12">
														<div class="signin-form">
															...
															<form action="admin.php?controller=home&action=login" id=""
																	...
																	<div class="form-group">
																		<div class="col-md-12">
																			<a class="pull-right" id="headerRecover"
																				href="index.php?controller=forgot-password">(Quên
																				mật khẩu?)</a>
																...
																<div class="row">
																	<button type="submit"
																		class="btn btn-primary pull-right push-bottom">Đăng
																		nhập</button>
																</div>
															</form>
															<p class="sign-up-info">Bạn chưa có tài khoản? <a href="#"
																	id="headerSignUp">Đăng ký</a></p>
														</div>
														<div class="signup-form">
															<span class="mega-menu-sub-title">Tạo tài khoản mới</span>
															<form action="index.php?controller=register" id=""
																method="post">
																<div class="row">
																	<div class="form-group">
																		<div class="col-md-12">
																	...
																	<div class="form-group">
																		...
																		<div class="col-md-6">
																			...
																			<input name="confirmPassword"
																				placeholder="Xác nhận Password" required
																				type="password" value=""
																				class="form-control input-lg">
																		</div>
																	</div>
															...
															<p class="log-in-info">Bạn đã có tài khoản? <a href="#"
																	id="headerSignIn">Đăng nhập</a></p>
														</div>
														<div class="recover-form">
															<span class="mega-menu-sub-title">Đặt lại mật khẩu</span>
															<p>Hoàn thành mẫu dưới đây để nhận email với mã ủy quyền cần
																thiết để đặt lại mật khẩu của bạn.</p>
															<form
																action="index.php?controller=forgot-password&amp;action=request"
																id="" method="post">
																<div class="row">
																	<div class="form-group">
																		<div class="col-md-12">
																			...
																			<input type="text" name="email"
																				placeholder="Nhập Email" autofocus value=""
																				class="form-control input-lg">
																		</div>
																	</div>
																</div>
															...
															<p class="log-in-info">Bạn đã có tài khoản? <a href="#"
																	id="headerRecoverCancel">Đăng nhập</a></p>
														</div>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="user-avatar">
															<div class="img-thumbnail">
																<img src="public/upload/images/<?= $user_login['user_avatar'] ?>"
																	alt="<?= $user_login['user_name'] ?>">
															</div>
															<p><strong>
																	<?= $user_login['user_name'] ?>
																</strong><span>
																	<?php if ($user_login['role_id'] == 0)
																		echo 'Khách hàng';
													...
													<div class="col-md-6">
														<ul class="list-account-options">
															<li><a
																	href="admin.php?controller=user&action=info&user_id=<?= $user_nav ?>">Tài
																	khoản của tôi</a></li>
															<li><a href="admin.php?controller=purchase">Đơn mua của tôi</a>
															</li>
															<li><a href="admin.php?controller=home&action=logout">Đăng
																	xuất</a></li>
														</ul>
													</div>
												</div>
							...
							<div class="search">
								<form id="searchForm" action="<?php echo PATH_URL; ?>search/" method="get">
									<div class="input-group">
										<input type="text" class="form-control search" name="keyword" id="q"
